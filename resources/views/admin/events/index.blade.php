            ...
            <div class="col-xl-9">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1" id="cardTitle">Add New Event</h4>
                    </div>
                    <div class="card-body">
    ...
    <div class="container-fluid" id="contentContainer">
        <ul class="nav nav-tabs mb-3" id="eventTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="list-tab" data-bs-toggle="tab" data-bs-target="#list" type="button" role="tab">Events List</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="sort-tab" data-bs-toggle="tab" data-bs-target="#sort" type="button" role="tab">Sort Events</button>
            </li>
        </ul>
        ...
        <div class="tab-content" id="eventTabContent">
            <div class="tab-pane fade show active" id="list" role="tabpanel">
                <div class="card">
                    <div class="card-header"><h4 class="card-title mb-0">All Events</h4></div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="eventTable" class="table table-bordered table-striped" style="width: 100%">
                                <thead>
                                    <tr>
                                        <th>Sl</th>
                                        <th>Image</th>
            ...
            <div class="tab-pane fade" id="sort" role="tabpanel">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Sort Events</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody id="sortable">
                                    @foreach ($events as $index => $event)
                                        <tr data-id="{{ $event->id }}" style="cursor:grab;">
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ $event->title }}</td>
                                        </tr>
                                    @endforeach
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="quickCatName" placeholder="e.g. Conferences, Webinars">
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#saveBtn').on('click', function() {
                var id = $('#eventId').val();
                var url = id ? '{{ route('event.update') }}' : '{{ route('event.store') }}';
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $.get(url, function(res) {
                    if (res.success) {
                        ...
                        $('#event_date').val(d.formatted_date);
            ...
            $(document).on('change', '.toggle-status', function() {
                var id = $(this).data('id');
                $.post('{{ route('event.toggleStatus') }}', { id: id }, function(res) {
                    reloadTable('#eventTable');
                    showSuccess(res.message);
                });
            });
