!(function () {
  ...
  function u(e) {
    document.getElementById("header-lang-img") &&
      ("en" == e
        ? (document.getElementById("header-lang-img").src = "backend/images/flags/us.svg")
        : "sp" == e
          ? (document.getElementById("header-lang-img").src = "backend/images/flags/spain.svg")
          : "gr" == e
            ? (document.getElementById("header-lang-img").src = "backend/images/flags/germany.svg")
            : "it" == e
              ? (document.getElementById("header-lang-img").src = "backend/images/flags/italy.svg")
              : "ru" == e
                ? (document.getElementById("header-lang-img").src = "backend/images/flags/russia.svg")
                : "ch" == e
                  ? (document.getElementById("header-lang-img").src = "backend/images/flags/china.svg")
                  : "fr" == e &&
                  (document.getElementById("header-lang-img").src = "backend/images/flags/french.svg"),
    ...
    !a ||
      ...
      ((document.querySelector(".navbar-menu").innerHTML = i),
        ...
        document
          ...
          .forEach(function (a) {
            var o = (o = "/" == location.pathname ? "index.html" : location.pathname.substring(1)).substring(
              o.lastIndexOf("/") + 1
            );
            a.addEventListener("click", function (e) {
              var t;
              (o != "/" + a.getAttribute("href") || a.getAttribute("data-bs-toggle")) &&
    ...
    e < 1025 && 767 < e
      ...
      : 1025 <= e
        ...
        (document.body.classList.remove("vertical-sidebar-enable"),
          ...
          "twocolumn" == sessionStorage.getItem("data-layout") &&
          (document.documentElement.setAttribute("data-layout", "vertical"), A("vertical"), g()),
  ...
  function p(e) {
    if (e.target && e.target.matches("a.nav-link span"))
      if (0 == y(e.target.parentElement.nextElementSibling))
        ...
        for (var t = document.getElementsByClassName("dropdown-custom-right"); 0 < t.length;)
    ...
    if (e.target && e.target.matches("a.nav-link"))
      if (0 == y(e.target.nextElementSibling))
        ...
        for (t = document.getElementsByClassName("dropdown-custom-right"); 0 < t.length;)
          t[0].classList.remove("dropdown-custom-right");
  }
  function E() {
    var e = document.documentElement.clientWidth;
  ...
  function w() {
    feather.replace();
    var e,
      t = "/" == location.pathname ? "index.html" : location.pathname.substring(1);
        ...
        ? (e.classList.add("active"),
          (t =
            (t = e.closest(".collapse.menu-dropdown")) && t.parentElement.closest(".collapse.menu-dropdown")
              ...
              : (e.closest(".collapse.menu-dropdown").parentElement.classList.add("twocolumn-item-show"),
                t.getAttribute("id"))),
  ...
  sessionStorage.getItem("defaultAttribute")
    ...
    e[0].addEventListener("click", function (e) {
      s.hasAttribute("data-layout-mode") && "dark" == s.getAttribute("data-layout-mode")
        ? x("data-layout-mode", "light", "layout-mode-light", s)
        : x("data-layout-mode", "dark", "layout-mode-dark", s);
      localStorage.setItem("data-layout-mode", s.getAttribute("data-layout-mode"));
    }),
    v(),
    I(),
    f(),
      ...
      document.querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn").forEach(function (e) {
        e.addEventListener("click", function (e) {
          d--,
            ...
            q(),
            (document.getElementById("empty-cart").style.display = 0 == d ? "block" : "none"),
            (document.getElementById("checkout-elem").style.display = 0 == d ? "none" : "block");
        });
      })),
    ...
    document.querySelectorAll("[data-provider]").forEach(function (e) {
      ...
      "flatpickr" == e.getAttribute("data-provider")
        ? ((o = {}),
          ...
          t["data-enable-time"] &&
          ((o.enableTime = !0), (o.dateFormat = t["data-date-format"].value.toString() + " H:i")),
          ...
          ((o.mode = "multiple"), (o.dateFormat = t["data-date-format"].value.toString())),
          ...
          ((o.inline = !0),
            ...
            (o.dateFormat = t["data-date-format"].value.toString())),
          t["data-disable-date"] &&
          ((a = []).push(t["data-disable-date"].value), (o.disable = a.toString().split(","))),
          flatpickr(e, o))
